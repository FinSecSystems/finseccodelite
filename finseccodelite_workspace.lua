--
-- Name:        finseccodelite/finseccodelite_workspace.lua
...
--
	...
	finseccodelite.workspace = {}
	local m = finseccodelite.workspace
...
--		local tagsdb = "./" .. wks.name .. ".tags"
		...
		if numPlatforms >= 2 then
			finseccodelite.workspace.multiplePlatforms = true
		end
